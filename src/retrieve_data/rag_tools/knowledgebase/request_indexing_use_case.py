...
from .entities import KnowledgeBaseIndexingResponse
...
print(settings.ORACLE_ABI_PATH)
#with open(settings.ORACLE_ABI_PATH, "r", encoding="utf-8") as f:
with open("/home/g10m/Documents/projects/ETHGlobal/AgentPlatform/src/retrieve_data/rag_tools/oracles/chatOracle.json", "r", encoding="utf-8") as f:
